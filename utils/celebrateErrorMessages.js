const errorMessages = {
  ...
  password: {
    'string.pattern.base': 'Поле {#label} должно состоять из латинских букв, содержать как минимум 1 цифру, 1 спецсимвол, 1 прописную букву, 1 заглавную букву, длина от 6 символов.',
  },
  id: {
